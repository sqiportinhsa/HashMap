...
Рассчитаем коэффициенты полезности ассемблерных оптимизаций как `ускорение программы` * $1000$ / `количество строк, написанных на ассемблере`:

| оптимизация | время работы функции поиска, ms | улучшение относительно предыдущей версии | улучшение относительно v0 | коэффициент оптимизации |
|:-: |       :-:      |  :-:             |      :-:       | :-:  |
| v0 | $3080  \pm 13$ | -                | -              | -    |
...
Таким образом, коэффициент улучшения падает в процессе оптимизаций, что говорит о необходимости остановки.